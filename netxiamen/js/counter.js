...
function _jsq_encode(){
    ...
    _utf8_encode=function(a){
        a=a.replace(/\r\n/g,"\n");
        var b=new Array();var d=0;
        for(var n=0;n<a.length;n++){var c=a.charCodeAt(n);
            if(c<128){b[d++]=c}
            else{
                if((c>127)&&(c<2048)){b[d++]=(c>>6)|192;b[d++]=(c&63)|128}
                else{b[d++]=(c>>12)|224;b[d++]=((c>>6)&63)|128;b[d++]=(c&63)|128}
            }
        }
            return b
    }
...
function _jsq_(treeid,pagename,newsid,owner){
    if(window.top!=window){return}var c=navigator.appName=="Netscape"?screen.pixelDepth:screen.colorDepth;
